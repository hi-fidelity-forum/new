...
<tr>
	<td class="tcat" colspan="3"><span class="smalltext"><strong>Название темы</strong></span></td>
	<td class="tcat" width="100" align="center" style="white-space: nowrap"><span class="smalltext"><strong>Раздел</strong></span></td>
	<td class="tcat" width="60" align="center" style="white-space: nowrap"><span class="smalltext"><strong>Сообщений</strong></span></td>
	<td class="tcat" width="60" align="center" style="white-space: nowrap"><span class="smalltext"><strong>Просмотров</strong></span></td>
	<td class="tcat" width="150" align="center"><span class="smalltext"><strong>Последнее сообщение</strong></span></td>
	<?php
	
	if ($session->user()->isModer())
	{
		echo '<td class="tcat" align="center" width="1"><input type="checkbox" name="allbox" onclick="selectAll(this)"></td>';
	}
...
<table width="100%" align="center" border="0">
			<tbody><tr class="">
				...
				<td align="right" valign="top"><!-- start: search_results_threads_inlinemoderation -->
...
<input type="button" onclick="javascript:inlineModeration.clearChecked();" value="Очистить" class="button">
