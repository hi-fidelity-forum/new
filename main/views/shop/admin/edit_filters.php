...
if ($filters)
{
	echo '<table class="admin_form_table"><tr class="thead"><td width="20">&nbsp;</td><td width="160px">Title</td><td width="90px">Name</td><td width="160px">Style</td><td width="70px">Type</td><td width="50px">Условие</td><td width="50px">Статус</td><td width="200px">Обязательное</td><td width="20px"></td></tr>';
	$even = false;
	foreach($filters as $filter)
	{
		...
		echo '<td><a href="" onClick="return remove_filter('.$filter['id'].')"><img src="/img/icons/delete.png" height="16px" /></a></td>';
		echo '</tr>';
		if (in_array($filter['type'], array('select', 'check')))
		{
			...
			{
				echo '<span>'.$item['item_title'].'</span> = <span>'.$item['item_value'].'</span><br />';
			}
