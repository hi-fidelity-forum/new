	...
	public static function handler(Exception $e)
	{
		try
		{
			...
			if ( ! headers_sent())
			{
				...
				header('Content-Type: '.self::$error_view_content_type.'; charset=utf-8', TRUE, $http_header_status);
			}
			...
			if ($view_file = findFile('views', self::$error_view))
			{
				include $view_file;
			}
			else
			{
				throw new NException('Error view file does not exist: views/:file', array(
